...
src_path = Path(__file__).parent.parent / "app" / "repository_layer" / "models"
...
# this is the Alembic Config request_data
...
# Add your model's MetaData request_data here for 'autogenerate' support
