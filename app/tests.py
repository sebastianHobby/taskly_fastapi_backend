...
from app.repository_layer.models import TaskContainerTypes
from app.service_layer.schemas import ProjectGet
...
def test_get_by_uuid_404(client):
    # project_repo_mock = AsyncMock(spec=AbstractDatabaseRepository)
...
#
#
# @mock.patch("webapp.service_layer.uuid4", return_value="xyz")
