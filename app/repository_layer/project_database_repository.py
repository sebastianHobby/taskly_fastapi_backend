...
from app.repository_layer.project_filtersets import ProjectFiltersetRules
from app.repository_layer.models.models import DatabaseBaseModel, Project


class ProjectDatabaseRepository(AbstractDatabaseRepository):
    ...
    async def get_filterset(self, params: dict, session: AsyncSession) -> Any:
        ...
        filterset = ProjectFiltersetRules(session=session, query=base_query)
        return filterset
